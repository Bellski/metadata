...
public class AddressMetadata extends AbstractMetadata<Address> implements AddressProperties<MetaProperty> {
	...
	ru.bellski.metadata.yet.NestedMetaProperty<Address, PermanentAddress, PermanentAddressProperties<String>> permanentAddress = new ru.bellski.metadata.yet.NestedMetaProperty<Address, PermanentAddress, PermanentAddressProperties<String>>() {
