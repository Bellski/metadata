...
public class MetaSqlFile extends PsiFileBase {
    ...
    public void subtreeChanged() {
        ...
        ApplicationManager.getApplication().invokeLater(() -> FileContentUtil.reparseFiles(InjectedLanguageUtil.findInjectionHost(MetaSqlFile.this).getContainingFile().getVirtualFile()));
    }
