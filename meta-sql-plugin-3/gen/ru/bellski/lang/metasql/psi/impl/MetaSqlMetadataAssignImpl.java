...
public class MetaSqlMetadataAssignImpl extends MetaSqlPsiCompositeElementImpl implements MetaSqlMetadataAssign {

  public MetaSqlMetadataAssignImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MetaSqlVisitor visitor) {
    visitor.visitMetadataAssign(this);
  }
