...
public class MetaSqlImportReferenceElementImpl extends MetaSqlPsiReferenceImpl implements MetaSqlImportReferenceElement {

  public MetaSqlImportReferenceElementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MetaSqlVisitor visitor) {
    visitor.visitImportReferenceElement(this);
  }
