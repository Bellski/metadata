...
public class MetaSqlReturnStatementImpl extends MetaSqlPsiCompositeElementImpl implements MetaSqlReturnStatement {

  public MetaSqlReturnStatementImpl(ASTNode node) {
    super(node);
  }
