...
import static org.vaadin.rise.codegen.ligt.tests.TestUtils.*;

/**
 * Created by oem on 8/5/16.
 */
public class NameTokenPartsGenerationTest {
	@Test
	public void test() throws Exception {
		...
		loadSources("/codegen/generated/", "NameTokenParts.java").forEach(javaFileObject -> and.generatesSources(javaFileObject));
	}
}
