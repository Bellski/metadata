...
/**
 * A slot for an ordered getLazyPresenter.
 * The getLazyPresenter placed in this slot must implement comparable and will
 * be automatically placed in order in the getView.
 * @param <T> - The type of getLazyPresenter, must extend comparable.
 */
